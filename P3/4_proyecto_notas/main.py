    ...
    while opcion:
        ...
        if opcion=="1" or opcion=="REGISTRO":
            ...
            if resultado:
                ...
                print(f"\n\t ...Porfavor inentelo de nuevo. No fue posible registrar el usuario")
    ...
    while True:
        ...
        if opcion == '1' or opcion=="CREAR":
            ...
            if len(lista_notas)>0:
                print("\n\tMostrar notas")
                print(f"{'ID':<10}{'Título':<15}{'Descripción':<15}{'fecha':<15}")
                print(f"-"*80)
                for fila in lista_notas:
                    print(f"{fila[0]:<10}{fila[2]:<15}{fila[3]:<15}{str(fila[4]):<15}")
                    print(f"-"*80)
            else:
                print(f"\n\t No existen notas")
            funciones.esperarTecla()
